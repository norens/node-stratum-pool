...
var JobManager = module.exports = function JobManager(options){
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        if (options.coin.algorithm === 'primesr') {
            if (nTime.length !== 16) {
        ...
        if (options.coin.algorithm === 'primesr') {
            headerBuffer = job.serializePrimesrHeader(merkleRoot, nTime, nonce);
            shareDiff = hashDigest(headerBuffer, nTimeInt);
            candidate = shareDiff === 6;
        } else {
            ...
            candidate = job.target.ge(headerBigNum);
        }
